...
**amount_eur** | **string** | Amount of the operation in decimal format in terminal currency, only in successful operations | [optional] 
**terminal_currency** | **string** | Currency of the PAYCOMET terminal. | [optional] 
**amount_eur_display** | **string** | Literal of the operation amount in PAYCOMET terminal currency (with currency symbol) and possible conversion applied in multicurrency operations | [optional] 
...
**merchant_data** | [**\Swagger\Client\Model\InlineResponse20016PaymentMerchantData**](InlineResponse20016PaymentMerchantData.md) |  | [optional] 
**history** | [**\Swagger\Client\Model\InlineResponse20016PaymentHistory[]**](InlineResponse20016PaymentHistory.md) |  | [optional] 
